...
{   
    global $post;
    $ezeebe_property_code  = (get_option('ezee_procode') == '') ? "thetamarind" : get_option('ezee_procode');
}

function ezee_be_settings($instance)
{

    $ezeebe_property_code = (get_option('ezee_procode') != '') ? get_option('ezee_procode') : 'thetamarind';   
...
{ 
    ...
    $ezeebe_bepropertyname = (get_option('ezee_procode') != '') ? get_option('ezee_procode') : 'thetamarind';                          
    $ezeebe_bepropertynameurl = "https://live.ipms247.com/booking/book-rooms-".$ezeebe_bepropertyname;
    $ezeebe_iframecode = 
            ' 
            <p style="text-align:center;"><iframe src="'.$ezeebe_bepropertynameurl.'" width=100% height=1125 frameborder="0" name="editframe" class="editframe" id="editframe" marginheight="83" marginwidth="188" scrolling="no" align="center">
            </iframe></p>
            ';
