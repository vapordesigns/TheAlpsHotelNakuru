		...
		FusionPageBuilder.fusion_flip_box = FusionPageBuilder.ChildElementView.extend( {
			...
			computeAtts: function( values ) {
				...
				if ( values.image && '' !== values.image ) {
					...
					if ( values.animation_type && 'yes' !== values.icon_spin ) {
						...
						flipBoxAttributes = jQuery.extend( flipBoxAttributes, animations );

						flipBoxAttributes[ 'class' ] += ' ' + flipBoxAttributes.animation_class;
						delete flipBoxAttributes.animation_class;
					}
