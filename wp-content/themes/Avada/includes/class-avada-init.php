...
class Avada_Init {
	...
	public function load_textdomain() {
		...
		if ( ! $loaded ) {
			add_filter( 'theme_locale', [ $this, 'change_locale' ], 10, 2 );
			$loaded = load_theme_textdomain( 'Avada', Avada::$template_dir_path . '/languages' );

			// Path: wp-content/theme/languages/avada-en_US.mo.
			// Path: wp-content/languages/themes/avada-en_US.mo.
			if ( ! $loaded ) {
				remove_filter( 'theme_locale', [ $this, 'change_locale' ] );
				add_filter( 'theme_locale', [ $this, 'change_locale_lowercase' ], 10, 2 );
				$loaded = load_theme_textdomain( 'Avada', Avada::$template_dir_path . '/languages' );

				// Path: wp-content/languages/Avada-en_US.mo.
				if ( ! $loaded ) {
					remove_filter( 'theme_locale', [ $this, 'change_locale_lowercase' ] );
					add_filter( 'theme_locale', [ $this, 'change_locale' ], 10, 2 );
