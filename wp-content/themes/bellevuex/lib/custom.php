...
function th_register_required_plugins() {
	...
	$plugins = array(
        ...
        array(
            ...
            'source'    => 'https://www.dropbox.com/s/hk8f8md37m11m0q/th-widget-pack.zip?dl=1',
            'required'  => true,
        ),
        array(
    ...
    if ( get_theme_mod('themo_tgmpa_hotel_booking',true) ){
        array_push($plugins, array(
            ...
            'source' => 'https://www.dropbox.com/s/vkkzum3nd4kgug2/motopress-hotel-booking.zip?dl=1',
            'required' => false,
        ));
    }
    ...
    if ( get_theme_mod('themo_tgmpa_hotel_booking_woocommerce_payments',false) ){
        array_push($plugins, array(
            ...
            'source' => 'https://www.dropbox.com/s/v0h6sckd3htbqn6/mphb-woocommerce.zip?dl=1',
            'required' => false,
        ));
    }
