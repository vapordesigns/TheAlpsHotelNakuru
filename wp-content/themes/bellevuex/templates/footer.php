...
if ( function_exists( 'get_theme_mod' ) ) {
    ...
    // Footer Diver
    $themo_footer2_divder = get_theme_mod( 'themo_footer2_divder', false );

    // Footer Copyright
    $themo_footer_copyright_switch = get_theme_mod( 'themo_footer_copyright_switch', false );
...
<footer class="footer" role="contentinfo">
    ...
    <?php } ?>
    <?php if ($themo_footer_copyright_switch && ($themo_footer_copyright_output > "" || $themo_footer_credit_output > "") ){ ?>
