...
?>
<div class="post-meta"><span class="show-author"><?php echo esc_html__('Posted by', 'bellevue'); ?> <?php echo the_author_posts_link(); ?></span> <span class="show-date"><span class="pre-date"><?php echo esc_html__('on', 'bellevue'); ?></span> <time class="published" datetime="<?php echo get_the_time('c'); ?>"><?php echo wp_kses_post( $link_the_date_open );?><?php echo get_the_date(); ?><?php echo wp_kses_post( $link_the_date_close );?></time></span> <span class="is-sticky">| <?php echo esc_html__('Featured', 'bellevue'); ?></span> <span class="show-comments"><?php echo wp_kses_post( $write_comments ); ?></span></div>
