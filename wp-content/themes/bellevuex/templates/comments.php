<?php
 ...
 if (have_comments()) : ?>
  <section id="comments">
    ...
    <?php if (!comments_open() && !is_page() && !is_singular( 'mphb_room_service' ) && !is_singular( 'mphb_room_type' ) && post_type_supports(get_post_type(), 'comments')) : ?>
...
<?php if (!have_comments() && !comments_open() && !is_page() && !is_singular( 'mphb_room_service' ) && !is_singular( 'mphb_room_type' ) && post_type_supports(get_post_type(), 'comments')) : ?>
  <section id="comments">
	  <div class="comments-closed">
		  <?php esc_html_e('Comments are closed.', 'bellevue'); ?>
	  </div>
